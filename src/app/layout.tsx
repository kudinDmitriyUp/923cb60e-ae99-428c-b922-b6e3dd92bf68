...
export const metadata: Metadata = {
  ...
  description: "Experience authentic Ukrainian hospitality at DuckBar. Premium vodka, craft beers, traditional cuisine, and warm atmosphere in your local community.",
  keywords: "Ukrainian bar, restaurant, vodka, traditional food, local bar, reservations",
  metadataBase: new URL("https://duckbar.local"),
  alternates: {
    canonical: "https://duckbar.local"
  },
  openGraph: {
    title: "DuckBar - Your Favorite Ukrainian Bar",
    description: "Authentic Ukrainian hospitality with premium spirits and traditional cuisine",
    url: "https://duckbar.local",
    siteName: "DuckBar",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764141749259-1pn0wedu.jpg",
  ...
  twitter: {
    ...
    title: "DuckBar - Ukrainian Bar & Restaurant",
    description: "Authentic Ukrainian hospitality with premium spirits and traditional cuisine",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764141749259-1pn0wedu.jpg"]
  }
};
